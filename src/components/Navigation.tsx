...
export default function Navigation() {
  ...
  const updateActiveSection = useCallback(() => {
    const sections = ["stats", "guests", "episodes", "reach", "about", "gallery", "contact"];
                  ...
                  {navLinks.map((link) => {
                    ...
                    return (
                      <motion.a
                        ...
                        className={`relative px-4 py-2 font-medium text-sm tracking-wide transition-colors duration-300 group ${
                      ...
                      >
                        ...
                        <motion.span
                          className={`absolute inset-0 bg-white/5 rounded-lg transition-opacity duration-300 ${
                            isActive ? "opacity-100" : "opacity-0 group-hover:opacity-100"
                          }`}
                        />
                        <span className={`absolute bottom-0 left-1/2 -translate-x-1/2 h-0.5 bg-gradient-to-r from-[#E10600] to-[#ff4d4d] transition-all duration-300 rounded-full ${
