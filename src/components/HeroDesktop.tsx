...
export default function HeroDesktop() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen hidden lg:flex items-center justify-center overflow-hidden bg-black">
      {/* Video Background */}
        ...
        <div className="flex flex-col items-center text-center">
          ...
          >
            <img
              ...
              className="w-30 h-auto drop-shadow-[0_0_30px_rgba(225,6,0,0.3)]"
            />
          </motion.div>
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <span className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/5 backdrop-blur-md border border-white/10 text-sm text-gray-300 font-medium tracking-wide">
          ...
          {/* Main Headline */}
          <motion.h1
            className="font-display text-7xl xl:text-8xl 2xl:text-9xl font-bold text-white mb-6 tracking-tight leading-[0.9]"
          ...
          {/* Subheadline */}
          <motion.p
            className="font-body text-xl xl:text-2xl text-gray-300 max-w-3xl mx-auto mb-12 leading-relaxed"
          ...
          >
            <motion.a
              ...
              className="group relative inline-flex items-center gap-3 px-10 py-5 bg-[#E10600] text-white font-semibold text-lg rounded-lg overflow-hidden transition-all duration-300 hover:shadow-[0_0_50px_rgba(225,6,0,0.5)]"
            ...
            <motion.a
              ...
              className="group inline-flex items-center gap-3 px-10 py-5 bg-white/5 backdrop-blur-md text-white font-semibold text-lg rounded-lg border border-white/20 transition-all duration-300 hover:bg-white/10 hover:border-white/40"
              whileHover={{ scale: 1.03 }}
              whileTap={{ scale: 0.98 }}
            >
      ...
      <AnimatePresence>
        {isInView && (
          <motion.div
            className="absolute bottom-[0px] md:bottom-0 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 20 }}
